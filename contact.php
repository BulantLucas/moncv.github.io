<?php
/* Page: contact.php */
$VotreAdresseMail="bulant.lucas@gmail.com";//mettez ici votre adresse mail
        ...
        if(!preg_match("#^[a-z0-9_-]+((\.[a-z0-9_-]+){1,})?@[a-z0-9_-]+((\.[a-z0-9_-]+){1,})?\.[a-z]{2,}$#i",$_POST['email'])){
            ...
            if(empty($_POST['sujet'])) {
                ...
                if(empty($_POST['message'])) {
                    ...
                    $Entetes .= "From: Nom de votre site <".$_POST['bulant.lucas@gmail.com'].">\r\n";//de préférence une adresse avec le même domaine de là où, vous utilisez ce code, cela permet un envoie quasi certain jusqu'au destinataire
                    $Entetes .= "Reply-To: Nom de votre site <".$_POST['bulant.lucas@gmail.com'].">\r\n";
